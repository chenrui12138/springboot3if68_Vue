<template>
  <div class="main-content">
        ...
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '名称' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
                      v-model="searchForm.mingcheng" placeholder="名称" clearable></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search"
                      v-model="searchForm.mingcheng" placeholder="名称" clearable></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.mingcheng" placeholder="名称"
                      clearable></el-input>
          </el-form-item>
          ...
          <el-form-item class="select" label="状况" prop="zhuangkuang">
            <el-select @change="zhuangkuangChange" clearable v-model="searchForm.zhuangkuang" placeholder="请选择状况">
              <el-option
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              <el-button
                  v-if="isAuth('huiyishi','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="success"
              ...
              <el-button
                  v-if="isAuth('huiyishi','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
                  type="success"
                  size="mini"
                  @click="addOrUpdateHandler(scope.row.id,'info')">
                {{ contents.tableBtnFont == 1 ? '详情' : '' }}<i class="el-icon-tickets el-icon--right"/></el-button>
              <el-button
                  v-if="isAuth('huiyishi','查看') && contents.tableBtnIcon == 0"
                  type="success"
                  size="mini"
                  @click="addOrUpdateHandler(scope.row.id,'info')">
                {{ contents.tableBtnFont == 1 ? '详情' : '' }}
              ...
              <el-button
                  v-if="isAuth('huiyishi','预约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="success"
                  icon="el-icon-tickets"
                  size="mini"
                  @click="yuyuexinxiCrossAddOrUpdateHandler(scope.row,'cross','','','')">
                {{ contents.tableBtnFont == 1 ? '预约' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('huiyishi','预约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
                  type="success"
                  size="mini"
                  @click="yuyuexinxiCrossAddOrUpdateHandler(scope.row,'cross','','','')">
                {{ contents.tableBtnFont == 1 ? '预约' : '' }}<i class="el-icon-tickets el-icon--right"/></el-button>
              <el-button
                  v-if="isAuth('huiyishi','预约') && contents.tableBtnIcon == 0"
                  type="success"
                  size="mini"
                  @click="yuyuexinxiCrossAddOrUpdateHandler(scope.row,'cross','','','')">
                {{ contents.tableBtnFont == 1 ? '预约' : '' }}
              ...
              <el-button
                  v-if="isAuth('huiyishi','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('huiyishi','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
                  type="primary"
                  size="mini"
                  @click="addOrUpdateHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '修改' : '' }}
                <i class="el-icon-edit el-icon--right"/></el-button>
              <el-button v-if="isAuth('huiyishi','修改') && contents.tableBtnIcon == 0"
                         type="primary"
                         size="mini"
                         @click="addOrUpdateHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '修改' : '' }}
              ...
              <el-button
                  v-if="isAuth('huiyishi','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="danger"
                  icon="el-icon-delete"
                  size="mini"
              ...
              <el-button
                  v-if="isAuth('huiyishi','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('huiyishi','删除') && contents.tableBtnIcon == 0" type="danger" size="mini"
    ...
    <yuyuexinxi-cross-add-or-update v-if="yuyuexinxiCrossAddOrUpdateFlag" :parent="this"
                                    ref="yuyuexinxiCrossaddOrUpdate"></yuyuexinxi-cross-add-or-update>
...
export default {
  data() {
    return {
      ...
      contents: {
        ...
        "searchBtnBgColor": "rgba(48, 208, 182, 1)",
        "inputTitleSize": "14px",
        ...
        "inputTitle": "1",
        "tableBtnBorderRadius": "30px 0px 0px 0px",
        "btnAdAllFont": "1",
        "btnAdAllDelFontColor": "rgba(255, 255, 255, 1)",
        "tableBtnIcon": "0",
        "btnAdAllHeight": "45px",
        "btnAdAllWarnBgColor": "rgba(48, 208, 182, 1)",
        "btnAdAllBorderWidth": "5px",
        "tableStripeFontColor": "#606266",
        "tableBtnBorderStyle": "double",
        "inputHeight": "40px",
        "btnAdAllBorderRadius": "4px",
        "btnAdAllDelBgColor": "rgba(48, 208, 182, 1)",
        "pagePrevNext": true,
        "btnAdAllAddBgColor": "rgba(48, 208, 182, 1)",
        "searchBtnFont": "1",
        "tableIndex": true,
        "btnAdAllIcon": "1",
        "tableSortable": false,
        ...
        "tableBtnEditBgColor": "rgba(48, 208, 182, 1)",
        "box": {
          "padding": "10px 20px",
          "boxShadow": "0 0 0px rgba(0,0,0,0)",
          "flag": "1",
          "backgroundImage": "http://codegen.caihongy.cn/20211123/27e375b9de244161b1e849970e171c58.png",
          "background": "#fff url(\"http://codegen.caihongy.cn/20211123/50cc9048036f4492a8282b0fa503a1e7.png\") no-repeat top"
        },
        "inputBorderWidth": "5px",
        "inputFontPosition": "1",
        "inputFontColor": "rgba(255, 255, 255, 1)",
        "pageEachNum": 10,
        "tableHeaderBgColor": "rgba(48, 208, 182, 1)",
        "inputTitleColor": "rgba(48, 208, 182, 1)",
        "btnAdAllBoxPosition": "1",
        "tableBtnDetailBgColor": "rgba(48, 208, 182, 1)",
        "inputIcon": "1",
        "searchBtnIconPosition": "1",
        "btnAdAllFontSize": "12px",
        "inputBorderStyle": "double",
        "tableHoverFontColor": "#333",
        "inputBgColor": "rgba(48, 208, 182, 1)",
        "pageStyle": false,
        "pageTotal": true,
        ...
        "tableHoverBgColor": "rgba(245, 245, 245, 1)",
        ...
        "tableStripeBgColor": "rgba(252, 253, 253, 1)",
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (this.searchForm.zhuangkuang != '' && this.searchForm.zhuangkuang != undefined) {
        params['zhuangkuang'] = '%' + this.searchForm.zhuangkuang + '%'
      }
      this.$http({
        url: "huiyishi/page",
        method: "get",
