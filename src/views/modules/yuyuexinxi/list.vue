        ...
        >
          <el-form-item>
            ...
            >
              ...
              /></el-button>
              <el-button v-if="contents.btnAdAllIcon == 0" type="primary">{{
                contents.btnAdAllFont == 1 ? "导出" : ""
              }}</el-button>
            </download-excel>
          </el-form-item>
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                v-if="
                  isAuth('yuyuexinxi', '查看') && contents.tableBtnIcon == 0
                "
                type="success"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')"
              ...
              <el-button
                v-if="
                  isAuth('yuyuexinxi', '修改') && contents.tableBtnIcon == 0
                "
                type="primary"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id)"
              ...
              <el-button
                v-if="
                  isAuth('yuyuexinxi', '删除') && contents.tableBtnIcon == 0
                "
                type="danger"
                size="mini"
                @click="deleteHandler(scope.row.id)"
    ...
    return {
      ...
      contents: {
        ...
        box: {
          ...
          background:
            '#fff url("http://codegen.caihongy.cn/20211123/50cc9048036f4492a8282b0fa503a1e7.png") no-repeat top',
        },
