  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="工号" class="input" v-if="tableName=='yonghu'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.gonghao) && `yonghu` == this.tableName){
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20211123/7f23892376fd411f92accc24ee55c1f8.png);
